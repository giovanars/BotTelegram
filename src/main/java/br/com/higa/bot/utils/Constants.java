...
public class Constants {
    public static final String BOT_TOKEN = "SEU_TOKEN";
    ...
    public static final String MSG_ERRO_OPCAO_INVALIDA = "Não entendi, temos as opções abaixo. Tente uma delas.ss ";
    ...
    public static final String MSG_OLA_1 = "olá";
    public static final String MSG_OLA_2 = "ola";
    public static final String MSG_OI_1 = "oi";
}
